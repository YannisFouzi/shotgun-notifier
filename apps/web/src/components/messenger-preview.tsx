...
export function MessengerPreview({ message }: MessengerPreviewProps) {
  ...
  return (
    <div className="mx-auto flex h-[42rem] w-full max-w-[23rem] flex-col overflow-hidden rounded-[2.2rem] border border-black/20 bg-[#1c1e21] shadow-[0_28px_60px_rgba(0,0,0,0.38)]">
      ...
      {/* Header */}
      <div className="flex items-center gap-2.5 bg-[#242526] px-2 py-2.5 border-b border-[#3a3b3c]">
        <button
          type="button"
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-[11px] text-[#65676b]">Actif maintenant</p>
        </div>
